...
OnlyTP 是一个轻量级的 Minecraft NeoForge 模组，为您的游戏体验提供便捷的传送功能。无论您是在探索广阔的世界，还是要帮助有需要的朋友，OnlyTP 都能让您在 Minecraft 服务器中的旅行变得简单高效。
...
- **Minecraft 版本**: 1.21 至 1.21.11
- **加载器**: NeoForge，每个 Minecraft 版本使用对应的 `21.x` 构建
- **安装要求**: 服务端必需，客户端可选
  - 在客户端安装可获得本地化提示
  - 仅服务端安装时所有玩家使用服务器语言
